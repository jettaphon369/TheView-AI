...
const PRODUCT_DETAIL_KEY='theview:productDetail';
...
function bindRealtime(){
  ...
  unsubProducts = onSnapshot(userPath('products'), snap=>{ productsSnapshotReady=true; state.products=snap.docs.map(d=>({id:d.id,...d.data()})); render(); }, err=>{ productsSnapshotReady=true; showLoadError('โหลดสินค้าไม่สำเร็จ',err); });
  state.approvals=[];
