...
function ensurePasswordEyeStyles(){
  ...
  style.textContent=`
    ...
    .password-eye-btn:focus{outline:2px solid #93c5fd;outline-offset:1px;border-radius:10px}
  `;
...
window.togglePasswordVisibility=(inputId,button)=>{
  ...
  if(button){
    button.textContent=willShow?'🙈':'👁️';
    button.setAttribute('aria-label',willShow?'ซ่อนรหัสผ่าน':'แสดงรหัสผ่าน');
    button.setAttribute('title',willShow?'ซ่อนรหัสผ่าน':'แสดงรหัสผ่าน');
  }
};
