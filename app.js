...
const state = { user:null, page:'home', products:[], approvals:[], logs:[], selectedImage:null, imageMode:null, viewProductId:null, tempMoveImage:null, tempProductImage:null, stockFilter:'all', reportMode:'day', reportDate:'', reportMonth:'' };
const view = $('view');
