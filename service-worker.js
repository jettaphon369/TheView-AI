...
const CACHE_NAME = 'theview-stock-test-wjb-story-34-29-48-manual-pc-usability-fix';
const RUNTIME_CACHE = 'theview-stock-runtime-test-wjb-story-34-29-48-manual-pc-usability-fix';
const REQUIRED_ASSETS = [
  ...
  './manual.html',
  './reset.html',
  './main.css?v=34.29.48-test',
  './app.js?v=34.29.48-test',
  './firebase-config.js',
  './chee-chan-logo.png',
