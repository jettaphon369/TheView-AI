...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-29-52-r3-bulk-edit';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-29-52-r3-bulk-edit';
const REQUIRED_ASSETS = [
  ...
  './manual.html',
  './reset.html',
  './main.css?v=34.29.52-r3-bulk-edit-main',
  './app.js?v=34.29.52-r3-bulk-edit-main',
  './firebase-config.js',
  './chee-chan-logo.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async()=>{
    ...
    // v34.29.52 R3: clear older cache so bulk-edit UI/code is applied immediately.
