...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-21-2-admin-member-delete';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-21-2-admin-member-delete';
const REQUIRED_ASSETS = [
  './',
  './index.html',
  './qr.html',
  './manual.html',
  './main.css?v=34.21.2-main',
  './app.js?v=34.21.2-main',
  './firebase-config.js',
  './chee-chan-logo.png',
