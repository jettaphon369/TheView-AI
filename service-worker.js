...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-29-51-stock-structure-edit-delete-r2';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-29-51-stock-structure-edit-delete-r2';
const REQUIRED_ASSETS = [
  ...
  './manual.html',
  './reset.html',
  './main.css?v=34.29.51-r2-main',
  './app.js?v=34.29.51-r2-main',
  './firebase-config.js',
  './chee-chan-logo.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async()=>{
    ...
    // v34.29.51: clear older cache so stock structure edit/delete controls are applied immediately.
