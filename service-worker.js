...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-22-0-training-manual-upgrade';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-22-0-training-manual-upgrade';
const REQUIRED_ASSETS = [
  './',
  './index.html',
  './qr.html',
  './manual.html',
  './main.css?v=34.22.1-main',
  './app.js?v=34.22.1-main',
  './firebase-config.js',
  './chee-chan-logo.png',
