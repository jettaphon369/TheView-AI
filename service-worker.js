...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-29-52-multi-product-add-r1';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-29-52-multi-product-add-r1';
const REQUIRED_ASSETS = [
  ...
  './manual.html',
  './reset.html',
  './main.css?v=34.29.52-multi-add-r1-main',
  './app.js?v=34.29.52-multi-add-r1-main',
  './firebase-config.js',
  './chee-chan-logo.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async()=>{
    ...
    // v34.29.52: clear older cache so multi-product add UI/code is applied immediately.
