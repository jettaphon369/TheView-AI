...
const CACHE_NAME = 'theview-stock-main-theview-4d389-34-29-48-manual-pc-usability-fix';
const RUNTIME_CACHE = 'theview-stock-runtime-main-theview-4d389-34-29-48-manual-pc-usability-fix';
const REQUIRED_ASSETS = [
  ...
  './manual.html',
  './reset.html',
  './main.css?v=34.29.48-main',
  './app.js?v=34.29.48-main',
  './firebase-config.js',
  './chee-chan-logo.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async()=>{
    ...
    // v34.29.48: clear every older CHEE CHAN / TheView cache and use manual complete update assets only.
